...
---
  ...
  ## Rodar aplicação.
    ...
    $ git clone https://github.com/allesoares95/JavaScript

    # aplicação será aberta no http://127.0.0.1:5501/index.html

  ## JavaScript 
  é uma linguagem que, além de ser a padrão nos navegadores atuas, vem expandindo para outras áreas como servidores, banco de dados e até plataformas de Internet of Things (IoT).
